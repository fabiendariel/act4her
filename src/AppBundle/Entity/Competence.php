 ...
 * Competence
 *
 * @ORM\Table(name="t_competence_com")
...
class Competence
{
     ...
     * @var string
     *
     * @ORM\Column(name="com_lib", type="string", length=50)
     */
    private $label;
    
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Professionnel", mappedBy="competence")
     */
